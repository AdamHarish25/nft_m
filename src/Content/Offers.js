...
const Offers = () => {
  const className = {
    ...
    boxes:
      "w-fit h-auto grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 py-5 place-items-center lg:place-items-stretch",
    box1: {
      box1: "w-[470px] xl:w-auto h-auto py-10 px-4 border border-gray-400 rounded-xl font-Sora",
      title: "font-bold text-2xl px-5",
    ...
    box3: {
      ...
      lists: "w-full h-auto px-10 list-none space-y-5",
      list: "w-[400px] lg:w-full h-fit flex items-center gap-3",
      img: "h-full w-fit rounded-3xl",
      ...
      price:
        "bg-[#2A27C9]/20 text-[#2A27C9] w-fit h-fit p-2 rounded-lg text-center font-semibold text-xs",
